...
white_list["biopsy_surgical_procedure"] = ["type", "submitter_id", "age_at_procedure", "tumor_classification", "procedure_site", "procedure_type", "margins", "procedure_treatment_timing", "procedure_performed", "subjects.submitter_id", "timings.submitter_id", "mass_present", "viable_tumor_margin", "viable_tumor_specimen"]
